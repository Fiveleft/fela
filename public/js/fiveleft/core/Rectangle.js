(function(){
	...
	function Rectangle( x, y, w, h )
	{
		...
		this.width = w||0;
		this.height = h||0;
		this.tl = new fiveleft.Vector( this.x, this.y );
		this.br = new fiveleft.Vector( this.x+this.width, this.y+this.height );
		this.center = new fiveleft.Vector( this.x+(this.width/2), this.y+(this.height/2) );
		this.position = new fiveleft.Vector( this.x, this.y );
		return this.update();	
	}
